...
```{r echo=FALSE}
data = read.csv('C:\\Users\\sasia\\Desktop\\McCombs School of Business\\Summer Semester\\Introduction to Predictive Modeling\\Part-2-Dr.James\\Assignments\\Assignment-1\\social_marketing.csv')
```
